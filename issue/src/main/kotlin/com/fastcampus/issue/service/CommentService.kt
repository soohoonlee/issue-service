package com.fastcampus.issue.service

import com.fastcampus.issue.domain.Comment
import com.fastcampus.issue.domain.CommentRepository
import com.fastcampus.issue.domain.IssueRepository
import com.fastcampus.issue.exception.NotFoundException
import com.fastcampus.issue.model.CommentRequest
import com.fastcampus.issue.model.CommentResponse
import com.fastcampus.issue.model.toResponse
...
class CommentService(
    ...
    @Transactional
    fun edit(issueId: Long, id: Long, userId: Long, request: CommentRequest): CommentResponse? {
